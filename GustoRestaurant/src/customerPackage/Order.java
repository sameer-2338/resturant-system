...
public class Order
{
    ...
    public static int getNoOrders() //for genearting id numbers of new orders
    {
        ...
        try
        {
            PreparedStatement preparedStmt = MyConnection.getConnection().prepareStatement("SELECT count(*) FROM order_info");
    ...
    void updateDeliveryBoys(DeliveryBoy deliveryBoy)
    {
        ...
        try
        {
            ...
            if (deliveryBoy.getOrdersList().isEmpty())
            {
                ...
                String Query = " UPDATE delivery_boys SET status_delivery_boys=" + deliveryBoy.isAvailable()
