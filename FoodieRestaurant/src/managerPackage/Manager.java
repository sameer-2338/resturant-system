...
public class Manager extends User
{
    ...
    void addDeliveryBoy(DeliveryBoy deliveryBoy) throws ClassNotFoundException {
        try
        {

            String Query = "INSERT INTO delivery_boys (id_delivery_boys ,name_delivery_boys ,start_time_delivery_boys,finish_time_delivery_boys ,status_delivery_boys ,orderList_delivery_boys)"
                    + " VALUES (?,?,?,?,?,?,?)";
